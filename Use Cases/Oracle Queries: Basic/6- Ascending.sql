-- Create an Oracle SQL query to list employee names sorted by salary from lowest to highest.
...
(112,'Jose Manuel','Urman','JMURMAN','515.124.4469','07-MAR-2006','FI_ACCOUNT',7800.00,0.00,108,100);
